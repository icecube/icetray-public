...
html_title = "Steamshovel Documentation"

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = "Steamshovel Docs"
...
htmlhelp_basename = 'steamshoveldoc'
...
latex_documents = [
  ('index', 'steamshovel.tex', 'Steamshovel Documentation',
   'Steve Jackson', 'manual'),
]
