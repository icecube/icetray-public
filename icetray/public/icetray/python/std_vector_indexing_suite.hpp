...
namespace boost { namespace python {
    ...
    class std_vector_indexing_suite;
    
    namespace detail
    {
        template <class Container, bool NoProxy>
        class final_std_vector_derived_policies 
            : public std_vector_indexing_suite<Container, 
                NoProxy, final_std_vector_derived_policies<Container, NoProxy> > {};
    }
    ...
    template <
        ...
        class DerivedPolicies 
            = detail::final_std_vector_derived_policies<Container, NoProxy> >
    class std_vector_indexing_suite 
...
#endif // ICETRAY_PYTHON_STD_VECTOR_INDEXING_SUITE_HPP_INCLUDED
