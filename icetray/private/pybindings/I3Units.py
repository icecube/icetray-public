...
picosecond = icetray.picosecond(1)
...
s = icetray.s(1)
ms = icetray.ms(1)
minute = icetray.minute(1)
hour = icetray.hour(1)
day = icetray.day(1)
gregorianyear = icetray.gregorianyear(1)
julianyear = icetray.julianyear(1)
