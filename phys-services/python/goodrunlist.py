...
def GRL(pass2 = False):
    """
    Returns a complete list auf all good runs since IC79 (included). If you enable `pass2`,
    ...
    # Find all GRLs >= IC79
    lists = glob('/data/exp/IceCube/20[1-9][0-9]/filtered/level2{}/IC??_20[1-9][0-9]_GoodRunInfo.txt'.format('' if not pass2 else 'pass2'))
