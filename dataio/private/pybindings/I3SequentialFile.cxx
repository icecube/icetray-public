...
namespace {
  ...
  public:
    ...
    struct iterator 
    {
      boost::shared_ptr<I3SequentialFile> file;
      I3FramePtr next()
      {
	if (not file->more())
	  {
    ...
    static iterator make_iterator(boost::shared_ptr<I3SequentialFile> f)
    {
      if (f->mode_ != Reading)
...
{
  scope in_i3lootfile = class_<I3SequentialFile, boost::noncopyable>
    ("I3File", 
  ...
  class_<I3SequentialFile::iterator>("iterator")
    .def("next", &I3SequentialFile::iterator::next)
    ;
