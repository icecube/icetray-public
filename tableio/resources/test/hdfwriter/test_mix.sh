...
book() {
    tableio-hdfwriter_book ${I3_TESTDATA}/sim/Level3_nugen_numu_IC86.2012.011069.000000_20events.i3.bz2 $@ -n 2 --streams Final
}
...
tableio-hdfwriter_mix a.hdf5 b.hdf5 -o c.hdf5
