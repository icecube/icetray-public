...
Oct 30, 2025 don la dieu (nega at icecube.umd.edu)
--------------------------------------------------

* clean up misc docs (#4090)
* Remove All Star Imports (#3902)

Jul. 14, 2025 don la dieu (nega at icecube.umd.edu)
---------------------------------------------------
IceTray Release v1.15.3

* prune and reformat documentation (#3987)

Jun. 30, 2025 don la dieu (nega at icecube.umd.edu)
---------------------------------------------------
IceTray Release v1.15.0

* Documentation build process cleanup (#3915)
* remove or qualify unused variables (#3870)

Mar. 20, 2025 don la dieu (nega at icecube.umd.edu)
---------------------------------------------------
IceTray Release v1.14.0

* remove (most) of the calls to sprintf() (#3825)

Dec. 18, 2024 don la dieu (nega at icecube.umd.edu)
---------------------------------------------------
IceTray Release v1.13.0

* check for reused filenames (#3745)
...
* Make simclasses and recclasses optional for tests
...
* Py3k compatibility for hdfwriter-mix
...
* (r178437) add hdfwriter-book, a command-line interface to the I3HDFWriter
  segment
...
* (r160983) add zlib to the list of required tools
...
* (r151233) Remove PyTables extensions, as they clash with PyTables 3.3

April 29, 2016, Alex Olivas  (olivas@icecube.umd.edu)
-----------------------------------------------------
Release V16-04-00

* Add a one-stop shim for booking untriggered simulation
...
* Chase header churn in HDF5 1.8.14
