...
include(policies NO_POLICY_SCOPE)  # CMake policies shared with non-parasitic builds
...
macro(create_symlink _filepath _sympath)
  ...
  file(MAKE_DIRECTORY ${CMAKE_BINARY_DIR}/${_installdir})
  install(CODE "file(MAKE_DIRECTORY ${CMAKE_BINARY_DIR}/${_installdir})")
  file(CREATE_LINK ${_filepath} ${CMAKE_BINARY_DIR}/${_installdir}/${_symname} SYMBOLIC)
  install(CODE "file(CREATE_LINK ${_filepath} ${CMAKE_BINARY_DIR}/${_installdir}/${_symname} SYMBOLIC)")
