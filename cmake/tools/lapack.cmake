...
if(LAPACK_FOUND)
  ...
  if(OpenBLAS_FOUND)
    ...
    set(LAPACK_FOUND TRUE CACHE BOOL FORCE "Tool LAPACK found successfully")
    set(LAPACK_INCLUDE_DIR ${OpenBLAS_INCLUDE_DIRS} CACHE PATH FORCE "Headers for OpenBLAS")
    set(LAPACK_LIBRARIES ${OpenBLAS_LIBRARIES} CACHE PATH FORCE "Libraries for OpenBLAS")
  else(OpenBLAS_FOUND)
