...
if(LAPACK_FOUND)
  ...
  if(OpenBLAS_FOUND)
    ...
    set(LAPACK_FOUND TRUE CACHE BOOL "Tool LAPACK found successfully")
    set(LAPACK_INCLUDE_DIR ${OpenBLAS_INCLUDE_DIRS} CACHE PATH "Headers for OpenBLAS")
    set(LAPACK_LIBRARIES ${OpenBLAS_LIBRARIES} CACHE PATH "Libraries for OpenBLAS")
  else(OpenBLAS_FOUND)
