...
if(BLAS_FOUND)
  ...
  if(OpenBLAS_FOUND)
    ...
    set(BLAS_FOUND TRUE CACHE BOOL FORCE "Tool BLAS found successfully")
    set(BLAS_INCLUDE_DIR ${OpenBLAS_INCLUDE_DIRS} CACHE PATH FORCE "Headers for OpenBLAS")
    set(BLAS_LIBRARIES ${OpenBLAS_LIBRARIES} CACHE PATH FORCE "Libraries for OpenBLAS")
  else(OpenBLAS_FOUND)
