  ...
  if (Boost_FOUND)
    if (Boost_VERSION GREATER_EQUAL 106700)
      if (PYTHON_VERSION MATCHES "Python 2")
        ...
        find_package(Boost ${Boost_MAJOR_VERSION}.${Boost_MINOR_VERSION} EXACT COMPONENTS python36)
      endif()
    else()
      find_package(Boost ${Boost_MAJOR_VERSION}.${Boost_MINOR_VERSION} COMPONENTS python)
    endif()
  endif()
