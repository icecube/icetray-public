...
if(NOT USE_ROOT)
  ...
  if(NOT ROOT_VERSION)
    if(IS_DIRECTORY ${I3_PORTS}/root-v5.28.00d)
      set(ROOT_VERSION "5.28.00d")
    elseif(IS_DIRECTORY ${I3_PORTS}/root-v5.28.00)
    ...
    else(IS_DIRECTORY ${I3_PORTS}/root-v5.28.00d)
      message(FATAL_ERROR "Neither root v5.28.00(d) v5.27.06b v5.26.00e v5.24.00b v5.20.00 v5.18.00 found. Please install using ports.")
    endif(IS_DIRECTORY ${I3_PORTS}/root-v5.28.00d)
  ...
  set(ROOT_5.28.00d_LIBS Core Cint RIO Net Hist Graf Graf3d Gpad Tree Rint Postscript Matrix Physics MathCore Thread Minuit Gui)
