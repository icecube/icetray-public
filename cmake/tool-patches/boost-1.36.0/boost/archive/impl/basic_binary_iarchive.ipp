...
basic_binary_iarchive<Archive>::init(){
    ...
    * this->This() >> input_library_version;
    ...
    /** 
    TDS: gcc 3.2 icecube hack for warning

     /impl/basic_binary_iarchive.ipp:67: warning: choosing
    ...
    */
    ...
    basic_iarchive::set_library_version(input_library_version.operator const unsigned int&());
    #endif
