...
// #define BOOST_IOSTREAMS_DEFAULT_DEVICE_BUFFER_SIZE 65536
...
private:
	...
	// TDS:  manually give the filebuf a buffer that's the same size as
	// the rest of our devices
	static char buf[default_device_buffer_size];
	file_.pubsetbuf(buf, default_device_buffer_size);
#endif
      }
