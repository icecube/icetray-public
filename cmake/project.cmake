#
#  $Id: project.cmake 165886 2018-10-01 14:37:58Z nwhitehorn $
#  
...
macro(use_projects THIS_TARGET)
  ...
  foreach(USED_PROJECT ${${THIS_TARGET}_USE_PROJECTS_PROJECTS})
    ...
    if(NOT EXISTS ${CMAKE_SOURCE_DIR}/${USED_PROJECT}/CMakeLists.txt)
      message(FATAL_ERROR "Attempt to use project '${USED_PROJECT}', which doesn't contain a CMakeLists.txt")
...
macro(i3_executable THIS_EXECUTABLE_NAME)
  if(BUILD_${I3_PROJECT})
    ...
    no_dotfile_glob(${PROJECT_NAME}_${THIS_EXECUTABLE_NAME}_SOURCES ${${PROJECT_NAME}_${THIS_EXECUTABLE_NAME}_DEFAULT_ARGS})

    if(${PROJECT_NAME}_${THIS_EXECUTABLE_NAME}_NO_PREFIX)
      set(${PROJECT_NAME}_${THIS_EXECUTABLE_NAME}_TARGET_NAME ${THIS_EXECUTABLE_NAME})
    else(${PROJECT_NAME}_${THIS_EXECUTABLE_NAME}_NO_PREFIX)
      set(${PROJECT_NAME}_${THIS_EXECUTABLE_NAME}_TARGET_NAME ${PROJECT_NAME}-${THIS_EXECUTABLE_NAME})
