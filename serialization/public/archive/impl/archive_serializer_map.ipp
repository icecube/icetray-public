...
#include <archive/detail/basic_serializer_map.hpp>
...
template<class Archive>
I3_ARCHIVE_OR_WARCHIVE_DECL(bool)
...
archive_serializer_map<Archive>::erase(const basic_serializer * bs){
    if(icecube::serialization::singleton<
        extra_detail::map<Archive>
    >::is_destroyed())
        return;
...
template<class Archive>
I3_ARCHIVE_OR_WARCHIVE_DECL(const basic_serializer *)
