#ifndef I3_ARCHIVE_POLYMORPHIC_OARCHIVE_HPP
#define I3_ARCHIVE_POLYMORPHIC_OARCHIVE_HPP
...
#include <archive/detail/interface_oarchive.hpp>
...
namespace archive {
namespace detail {
    class I3_ARCHIVE_DECL(BOOST_PP_EMPTY()) basic_oarchive;
    class I3_ARCHIVE_DECL(BOOST_PP_EMPTY()) basic_oserializer;
}
...
public:
    ...
    void save_override(
                ...
                const
                #endif
                ::icecube::serialization::nvp< T > & t, int
        ){
        save_start(t.name());
...
// required by export
I3_SERIALIZATION_REGISTER_ARCHIVE(icecube::archive::polymorphic_oarchive)

#include <archive/detail/abi_suffix.hpp> // pops abi_suffix.hpp pragmas

#endif // I3_ARCHIVE_POLYMORPHIC_OARCHIVE_HPP
