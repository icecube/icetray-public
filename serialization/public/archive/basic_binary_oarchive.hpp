#ifndef I3_ARCHIVE_BASIC_BINARY_OARCHIVE_HPP
#define I3_ARCHIVE_BASIC_BINARY_OARCHIVE_HPP
...
protected:
    ...
    #if 0
    void save_override(const icecube::archive::version_type & t, int version){
    ...
    void save_override(const icecube::serialization::item_version_type & t, int version){
        library_version_type lvt = this->get_library_version();
        if(icecube::archive::library_version_type(7) < lvt){
            this->detail_common_oarchive::save_override(t, version);
        }
    ...
    void save_override(const serialization::collection_size_type & t, int){
        if (get_library_version() < icecube::archive::library_version_type(6)){
            unsigned int x=0;
            * this->This() >> x;
...
#endif // I3_ARCHIVE_BASIC_BINARY_OARCHIVE_HPP
