#ifndef I3_ARCHIVE_ITERATORS_MB_FROM_WCHAR_HPP
#define I3_ARCHIVE_ITERATORS_MB_FROM_WCHAR_HPP
...
public:
    ...
    template<class T>
    mb_from_wchar(I3_PFTO_WRAPPER(T) start) :
...
#endif // I3_ARCHIVE_ITERATORS_MB_FROM_WCHAR_HPP
