#ifndef I3_ARCHIVE_ITERATORS_BASE64_FROM_BINARY_HPP
#define I3_ARCHIVE_ITERATORS_BASE64_FROM_BINARY_HPP
...
public:
    ...
    template<class T>
    base64_from_binary(I3_PFTO_WRAPPER(T) start) :
        super_t(
...
#endif // I3_ARCHIVE_ITERATORS_BASE64_FROM_BINARY_HPP
