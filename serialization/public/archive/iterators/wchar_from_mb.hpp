#ifndef I3_ARCHIVE_ITERATORS_WCHAR_FROM_MB_HPP
#define I3_ARCHIVE_ITERATORS_WCHAR_FROM_MB_HPP
...
public:
    ...
    template<class T>
    wchar_from_mb(I3_PFTO_WRAPPER(T) start) :
...
wchar_t wchar_from_mb<Base>::drain(){
    ...
    if(0 >= result)
        icecube::serialization::throw_exception(iterators::dataflow_exception(
...
#endif // I3_ARCHIVE_ITERATORS_WCHAR_FROM_MB_HPP
