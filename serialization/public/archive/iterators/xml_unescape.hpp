#ifndef I3_ARCHIVE_ITERATORS_XML_UNESCAPE_HPP
#define I3_ARCHIVE_ITERATORS_XML_UNESCAPE_HPP
...
public:
    ...
    template<class T>
    xml_unescape(I3_PFTO_WRAPPER(T) start) :
...
#endif // I3_ARCHIVE_ITERATORS_XML_UNESCAPE_HPP
