#ifndef I3_ARCHIVE_ITERATORS_INSERT_LINEBREAKS_HPP
#define I3_ARCHIVE_ITERATORS_INSERT_LINEBREAKS_HPP
...
public:
    ...
    template<class T>
    insert_linebreaks(I3_PFTO_WRAPPER(T)  start) :
...
#endif // I3_ARCHIVE_ITERATORS_INSERT_LINEBREAKS_HPP
