#ifndef I3_ARCHIVE_ITERATORS_BINARY_FROM_BASE64_HPP
#define I3_ARCHIVE_ITERATORS_BINARY_FROM_BASE64_HPP
...
public:
    ...
    template<class T>
    binary_from_base64(I3_PFTO_WRAPPER(T)  start) :
        super_t(
            Base(I3_MAKE_PFTO_WRAPPER(static_cast< T >(start))),
            detail::to_6_bit<CharType>()
        )
    {}
...
#endif // I3_ARCHIVE_ITERATORS_BINARY_FROM_BASE64_HPP
