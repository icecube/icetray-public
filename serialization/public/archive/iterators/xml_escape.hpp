#ifndef I3_ARCHIVE_ITERATORS_XML_ESCAPE_HPP
#define I3_ARCHIVE_ITERATORS_XML_ESCAPE_HPP
...
public:
    ...
    template<class T>
    xml_escape(I3_PFTO_WRAPPER(T) start) :
...
#endif // I3_ARCHIVE_ITERATORS_XML_ESCAPE_HPP
