#ifndef I3_ARCHIVE_ITERATORS_TRANSFORM_WIDTH_HPP
#define I3_ARCHIVE_ITERATORS_TRANSFORM_WIDTH_HPP
...
public:
    ...
    template<class T>
    transform_width(I3_PFTO_WRAPPER(T) start) :
...
#endif // I3_ARCHIVE_ITERATORS_TRANSFORM_WIDTH_HPP
