#ifndef I3_ARCHIVE_SHARED_PTR_HELPER_HPP
#define I3_ARCHIVE_SHARED_PTR_HELPER_HPP
...
class shared_ptr_helper {
    ...
    struct void_deleter {
        ...
        void_deleter(const icecube::serialization::extended_type_info *eti) :
            m_eti(eti)
        {}
...
#else
    /*template<class Archive, class T>
    friend inline void icecube::serialization::load(
        Archive & ar,
        boost::shared_ptr< T > &t,
        const unsigned int file_version
    );*/
...
//  #endif
    ...
    I3_ARCHIVE_DECL(boost::shared_ptr<void>)
    get_od(
        const void * od,
...
public:
    ...
    void reset(boost::shared_ptr< T > & s, T * t){
        ...
        typedef BOOST_DEDUCED_TYPENAME boost::mpl::eval_if<
            ...
            boost::mpl::identity<polymorphic< T > >,
            boost::mpl::identity<non_polymorphic< T > >
        >::type type;
...
#endif // I3_ARCHIVE_SHARED_PTR_HELPER_HPP
