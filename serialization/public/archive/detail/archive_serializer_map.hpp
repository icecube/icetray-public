#ifndef I3_ARCHIVE_SERIALIZER_MAP_HPP
#define I3_ARCHIVE_SERIALIZER_MAP_HPP
...
class I3_ARCHIVE_OR_WARCHIVE_DECL(BOOST_PP_EMPTY())
...
#include <archive/detail/abi_suffix.hpp> // must be the last header

#endif //I3_ARCHIVE_SERIALIZER_MAP_HPP
