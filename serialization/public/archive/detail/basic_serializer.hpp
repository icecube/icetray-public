#ifndef I3_ARCHIVE_BASIC_SERIALIZER_HPP
#define I3_ARCHIVE_BASIC_SERIALIZER_HPP
...
public:
    ...
    const icecube::serialization::extended_type_info & get_eti() const {
        return * m_eti;
    }
};
...
#endif // I3_ARCHIVE_BASIC_SERIALIZER_HPP
