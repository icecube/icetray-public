#ifndef I3_ARCHIVE_DETAIL_HELPER_COLLECTION_HPP
#define I3_ARCHIVE_DETAIL_HELPER_COLLECTION_HPP
...
class helper_collection
{
    ...
    // note: we don't actually "share" the function object pointer
    // we only use shared_ptr to make sure that it gets deleted
...
#endif // I3_ARCHIVE_DETAIL_HELPER_COLLECTION_HPP
