#ifndef I3_SERIALIZATION_UTILITY_HPP
#define I3_SERIALIZATION_UTILITY_HPP
...
inline void serialize(
    ...
    ar & icecube::serialization::make_nvp("first", const_cast<typef &>(p.first));
    ar & icecube::serialization::make_nvp("second", p.second);
}
...
#endif // I3_SERIALIZATION_UTILITY_HPP
