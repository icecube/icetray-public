#ifndef I3_SERIALIZATION_VARIANT_HPP
#define I3_SERIALIZATION_VARIANT_HPP
    ...
    boost::static_visitor<> 
{
    ...
    {
        m_ar << I3_SERIALIZATION_NVP(value);
    }
private:
    Archive & m_ar;
};
    ...
    if(which >=  boost::mpl::size<types>::value)
        ...
        icecube::serialization::throw_exception(
            icecube::archive::archive_exception(
                icecube::archive::archive_exception::unsupported_version
            )
        );
...
#endif //I3_SERIALIZATION_VARIANT_HPP
