#ifndef I3_EXTENDED_TYPE_INFO_NO_RTTI_HPP
#define I3_EXTENDED_TYPE_INFO_NO_RTTI_HPP
...
class I3_SERIALIZATION_DECL(BOOST_PP_EMPTY()) extended_type_info_no_rtti_0 :
...
public:
    virtual bool
    is_less_than(const icecube::serialization::extended_type_info &rhs) const ;
    virtual bool
    is_equal(const icecube::serialization::extended_type_info &rhs) const ;
};
...
public:
    ...
    get_derived_extended_type_info(const T & t) const {
        ...
        return icecube::serialization::extended_type_info::find(derived_key);
    }
...
// before any of the other headers.
    ...
    struct extended_type_info_impl {
        typedef typename 
            icecube::serialization::extended_type_info_no_rtti< T > type;
    };
    } // namespace serialization
    } // namespace icecube
#endif
...
#endif // I3_EXTENDED_TYPE_INFO_NO_RTTI_HPP
