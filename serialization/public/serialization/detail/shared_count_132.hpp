...
public:
    ...
    void add_ref_lock()
    {
        ...
        mutex_type::scoped_lock lock(mtx_);
#endif
        if(use_count_ == 0) icecube::serialization::throw_exception(bad_weak_ptr());
        ++use_count_;
    }
...
public:
...
#endif
    {
        ...
        {
            d(p); // delete p
            icecube::serialization::throw_exception(std::bad_alloc());
        }
...
#endif
{
    ...
    {
        icecube::serialization::throw_exception(bad_weak_ptr());
    }
}
...
I3_SERIALIZATION_ASSUME_ABSTRACT(boost_132::detail::sp_counted_base)
...
#endif  // #ifndef BOOST_DETAIL_SHARED_COUNT_132_HPP_INCLUDED
