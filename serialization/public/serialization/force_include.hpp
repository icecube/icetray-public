#ifndef I3_SERIALIZATION_FORCE_INCLUDE_HPP
#define I3_SERIALIZATION_FORCE_INCLUDE_HPP
...
// the following help macro is to guarentee that certain code
...
#       define I3_DLLEXPORT __export
#   else
#       define I3_DLLEXPORT __declspec(dllexport)
#   endif
#elif ! defined(_WIN32) && ! defined(_WIN64)
#   if defined(__MWERKS__)
#       define I3_DLLEXPORT __declspec(dllexport)
#   elif defined(__GNUC__) && (__GNUC__ >= 3)
#       define I3_USED __attribute__ ((__used__))
...
#ifndef I3_SERIALIZATION_USED
#    define I3_SERIALIZATION_USED
#endif
...
#endif // I3_SERIALIZATION_FORCE_INCLUDE_HPP
