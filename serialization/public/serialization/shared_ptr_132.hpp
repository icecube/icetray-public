...
inline void serialize(
    ...
    icecube::serialization::void_cast_register<
...
inline void save_construct_data(
    ...
    ar << icecube::serialization::make_nvp("ptr", t->ptr);
}
...
inline void load_construct_data(
    ...
    P ptr_;
    ar >> icecube::serialization::make_nvp("ptr", ptr_);
...
inline void save(
    ...
    ar << icecube::serialization::make_nvp("pi", t.pi_);
}
...
I3_SERIALIZATION_SPLIT_FREE(boost_132::detail::shared_count)
...
inline void save(
    ...
    >(NULL));
    ar << icecube::serialization::make_nvp("px", t.px);
    ar << icecube::serialization::make_nvp("pn", t.pn);
}
...
#define I3_SHARED_POINTER_EXPORT_GUID(T, K)                     \
    typedef boost_132::detail::sp_counted_base_impl<               \
        T *,                                                       \
        boost::checked_deleter< T >                                \
    > __shared_ptr_ ## T;                                          \
    I3_CLASS_EXPORT_GUID(__shared_ptr_ ## T, "__shared_ptr_" K) \
    I3_CLASS_EXPORT_GUID(T, K)                                  \
    /**/

#define I3_SHARED_POINTER_EXPORT(T)                             \
    I3_SHARED_POINTER_EXPORT_GUID(                              \
        T,                                                         \
