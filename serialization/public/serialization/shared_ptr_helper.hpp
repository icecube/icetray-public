#ifndef I3_SERIALIZATION_SHARED_PTR_HELPER_HPP
#define I3_SERIALIZATION_SHARED_PTR_HELPER_HPP
...
#include <archive/detail/abi_prefix.hpp> // must be the last headern
...
public:
    ...
    friend void icecube::serialization::load(
        Archive & ar,
        SPT< U > &t,
        const unsigned int file_version
    );
    ...
    void reset(SPT< T > & s, T * t){
        ...
        if(NULL == true_type)
            icecube::serialization::throw_exception(
                icecube::archive::archive_exception(
                    icecube::archive::archive_exception::unregistered_class,
        ...
        if(NULL == oid)
            icecube::serialization::throw_exception(
                icecube::archive::archive_exception(
                    icecube::archive::archive_exception::unregistered_cast,
...
#endif // I3_SERIALIZATION_SHARED_PTR_HELPER_HPP
