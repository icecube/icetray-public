#ifndef I3_SERIALIZATION_STATIC_WARNING_HPP
#define I3_SERIALIZATION_STATIC_WARNING_HPP
...
struct static_warning_test{
    typename boost::mpl::eval_if_c<
        ...
        typename boost::mpl::identity<
            boost::mpl::print<
                I3_SERIALIZATION_STATIC_WARNING_LINE<L>
            >
        >
    >::type type;
};
...
#ifndef I3_STATIC_ASSERT_UNUSED_ATTRIBUTE
#  ifdef BOOST_ATTRIBUTE_UNUSED
#    define I3_STATIC_ASSERT_UNUSED_ATTRIBUTE BOOST_ATTRIBUTE_UNUSED
#  else
#    if defined(__GNUC__) && ((__GNUC__ > 4) || ((__GNUC__ == 4) && (__GNUC_MINOR__ >= 7)))
#      define I3_STATIC_ASSERT_UNUSED_ATTRIBUTE __attribute__((unused))
#    else
#      define I3_STATIC_ASSERT_UNUSED_ATTRIBUTE
#    endif
#  endif
#endif

#define I3_SERIALIZATION_BSW(B, L) \
    typedef icecube::serialization::I3_SERIALIZATION_SS< \
        sizeof( icecube::serialization::static_warning_test< B, L > ) \
    > BOOST_JOIN(STATIC_WARNING_LINE, L) I3_STATIC_ASSERT_UNUSED_ATTRIBUTE;
#define BOOST_STATIC_WARNING(B) I3_SERIALIZATION_BSW(B, __LINE__)

#endif // I3_SERIALIZATION_STATIC_WARNING_HPP
