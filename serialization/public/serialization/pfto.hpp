#ifndef I3_SERIALIZATION_PFTO_HPP
#define I3_SERIALIZATION_PFTO_HPP
...
// it is used to support  compilers that fail to support correct Partial
...
pfto_wrapper< T > make_pfto_wrapper(const pfto_wrapper< T > & t, int){
    ...
    #define I3_PFTO_WRAPPER(T) \
        icecube::serialization::pfto_wrapper< T >
    #define I3_MAKE_PFTO_WRAPPER(t) \
        icecube::serialization::make_pfto_wrapper(t, 0)
#else
    #define I3_PFTO_WRAPPER(T) T
    #define I3_MAKE_PFTO_WRAPPER(t) t
#endif

#endif // I3_SERIALIZATION_PFTO_HPP
