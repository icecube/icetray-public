#ifndef I3_SERIALIZATION_COMPLEX_HPP
#define I3_SERIALIZATION_COMPLEX_HPP
...
inline void save(
    ...
    const T re = t.real();
    const T im = t.imag();
    ar << icecube::serialization::make_nvp("real", re);
    ar << icecube::serialization::make_nvp("imag", im);
}
...
#endif // I3_SERIALIZATION_COMPLEX_HPP
