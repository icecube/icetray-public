...
#define I3_SERIALIZATION_TEST_TOOLS_HPP
...
#define I3_WARN_MESSAGE( P, M )  \
    ((P)? (void)0 : ::boost::detail::msg_impl( (M) , __FILE__, __LINE__, BOOST_CURRENT_FUNCTION))
#define I3_MESSAGE( M ) \
    BOOST_WARN_MESSAGE( true , (M) )

#define I3_CHECKPOINT( M ) \
    BOOST_WARN_MESSAGE( true , (M) )

//#define I3_TEST_DONT_PRINT_LOG_VALUE( T ) 

#define I3_FAIL( M ) BOOST_REQUIRE_MESSAGE( false, (M) )
