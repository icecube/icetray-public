...
void test_collection_size_type(){
    auto testfile = I3Test::testfile("test_collection_size_type");

    // test collection size
    size_t size = 0x1000000ff; // 4GB + 256 bytes
    ...
    icecube::serialization::collection_size_type cs2;
    std::string foo2;
    {
...
TEST_GROUP(collection_size_type)

#define TEST_SET(name) \
TEST(name ## _collection_size_type){ \
    test_collection_size_type<test_settings>(); \
}
